...
It defines Numba methods that are used in calculation of synchrotron radiation.

Apart from syntactic details, this file is very close to cuda_methods.py
"""
...
get_particle_lab_frame = jit( get_particle_lab_frame, nopython=True )
